...
const requiredPaths = [
  ...
  'docs/DATA_MODEL.md',
  'docs/DECISIONS.md',
  'docs/MASTER_DATA_CONTRACT.md',
  'docs/ATTENDANCE_CONTRACT.md',
  'docs/SAFE_BATCH_P2_P5_REPORT.md',
  'docs/MATCH_CONTRACT.md',
  'docs/ELIGIBILITY_CONTRACT.md',
  'docs/ROTATION_CONTRACT.md',
  'docs/CONVOCATION_CONTRACT.md',
  'docs/SAFE_BATCH_P6_P9_REPORT.md',
  'docs/PARTICIPATION_CONTRACT.md',
  'docs/COMMUNICATION_CONTRACT.md',
  'docs/AUDIT_CONTRACT.md',
  'docs/SHEET_RUNTIME_CONTRACT.md',
  'docs/SAFE_BATCH_P10_P13_REPORT.md',
  ...
  'docs/UI_PRODUCTIZATION_SAFE_BATCH_01.md',
  'docs/FINAL_UI_ACCEPTANCE_MATRIX.md',
  'src/appsscript.json',
  'src/AppsScriptRuntimeBootstrap.js',
  'src/AppClientController.js',
  'src/AppRenderer.js',
  'src/AppUi.js',
  'src/PanelHandlers.js',
  'src/PanelUi.js',
  ...
  'src/config/CompetitionSetup.js',
  'src/config/GlobalSetup.js',
  'src/config/PanelSetup.js',
  ...
  'src/domain/MatchContracts.js',
  'src/domain/AttendanceRules.js',
  'src/domain/EligibilityRules.js',
  'src/domain/RotationRules.js',
  'src/domain/ConvocationRules.js',
  'src/domain/ConvocationContracts.js',
  'src/domain/ParticipationContracts.js',
  'src/domain/CommunicationContracts.js',
  'src/domain/AuditContracts.js',
  'src/RuntimeComposition.js',
  'src/adapters/AppsScriptMailAdapter.js',
  'src/adapters/AppsScriptEnvironmentAdapter.js',
  'src/adapters/AppsScriptIdGenerator.js',
  'src/adapters/AppsScriptLockAdapter.js',
  'src/adapters/AppsScriptRepositoryFactory.js',
  ...
  'src/services/OperationalCommandService.js',
  'src/services/PanelQueryService.js',
  ...
  'tests/competition/match.test.js',
  'tests/competition/eligibility.test.js',
  'tests/competition/rotation.test.js',
  'tests/competition/convocation.test.js',
  ...
  'tests/operations/participation.test.js',
  'tests/operations/communication.test.js',
  'tests/operations/audit.test.js',
  'tests/operations/runtime.test.js',
  'tests/app/app-ui.test.js',
  'tests/panel/p14-panel-appsscript-readiness.test.js',
  'scripts/validate.js',
